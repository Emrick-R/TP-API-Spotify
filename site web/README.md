...
Ce projet est une application web qui interagit avec l'API Spotify pour afficher des informations sur les artistes et les morceaux. Il est construit en utilisant Go pour le backend et HTML/CSS pour le frontend.
